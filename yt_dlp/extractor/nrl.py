...
class NRLTVIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        if re.search(r'class=[\'"]locked-content-video-wrapper[\'"]', webpage):
        ...
        thumbnail = None
        for json_ld in self._yield_json_ld(webpage, video_id, fatal=False):
            thumbnail = traverse_obj(json_ld, ('thumbnail', 'url'), 'thumbnailUrl', {url_or_none})
            if thumbnail:
                break
